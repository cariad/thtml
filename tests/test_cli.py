...
@mark.parametrize(
    ...
    [
        ...
        (
            "google-fonts",
            """<style type="text/css">@import url('https://fonts.googleapis.com/css2?family=Roboto+Mono:wght@400&display=swap'); .thtml { background: #101013; border-radius: 0.5rem; color: var(--white); font-family: var(--default-font); letter-spacing: 0.03rem; margin-left: auto; margin-right: auto; padding: 2rem; width: max-content; --default-font: 'Roboto Mono'; --white: #CCC; --black: #000; } .thtml-code { font-family: inherit; } .foreground-black { border-color: var(--black); color: var(--black); } .foreground-default { border-color: var(--white); color: var(--white); }</style><pre class="nohighlight thtml"><code class="thtml-code"><span class="foreground-black">Hello, world!</span><span class="foreground-default"></span></code></pre>""",
        ),
        (
            "plain",
            """<style type="text/css">.thtml { --black: #000; } .foreground-black { border-color: var(--black); color: var(--black); } .foreground-default { border-color: var(--white); color: var(--white); }</style><pre class="nohighlight thtml"><code class="thtml-code"><span class="foreground-black">Hello, world!</span><span class="foreground-default"></span></code></pre>""",
        ),
    ],
)
